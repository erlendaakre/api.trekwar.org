...
<div class="container">
    ...
    <div class="row">
        <div class="span8">
            ...
            <h3>April 23 2009</h3>
            <p>I got lots of programming done during my easter vacation</p>

            <ul><li>Shipdesigner now complete: screenshot
            </li><li>Added the sound system to the game, including music and some sounds
            </li><li>Added chat system screenshot
            </li><li>Found and processed the images for 32 ship hulls
            </li></ul>
