...
<div class="container">
    ...
    <div class="row">
        <div class="span8">
            ...
            <p><g:link url="${assetPath(src: 'screenshots/trekwar_old_galaxy.jpg')}"><asset:image src="/screenshots/trekwar_old_galaxy_thumb.jpg" /></g:link></p>
            ...
            <p><g:link url="${assetPath(src: '/devblog/gui_research_sketch.png')}"><asset:image src='/devblog/gui_research_sketch_thumb.png'/></g:link> &nbsp;
        <g:link url="${assetPath(src: '/screenshots/trekwar_research.jpg')}"><asset:image src='/screenshots/trekwar_research_thumb.jpg'/></g:link>
                </p>
                <br/>
            <p>
                <b>Next time:</b><br/>
            ...
            <p><g:link url="${assetPath(src: '/devblog/gui_systemconfig_sketch.png')}"><asset:image src="/devblog/gui_systemconfig_sketch_thumb.png" /></g:link></p>
